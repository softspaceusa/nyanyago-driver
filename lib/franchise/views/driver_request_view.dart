...
class DriverRequestView extends StatefulWidget {
  ...
  const DriverRequestView({super.key, required this.id, this.scheduleData});
              ...
              children: [
                Padding(
                  ...
                  child: Row(
                    children: [
                      ProfileImage(
                          url: vm.driver.userData.photoPath, radius: 90),
                      ...
                      Column(
                        ...
                        children: [
                          ...
                          if (vm.driver.userData.videoPath.isNotEmpty)
                            Padding(
                              padding: const EdgeInsets.only(top: 10),
                              child: TextButton(
                                onPressed: () => vm.navigateToView(
                                  VideoView(
                                    url: vm.driver.userData.videoPath,
                                  ),
                                ),
                                child: const Row(
                                  children: [
                          ...
                          RichText(
                            ...
                            const TextSpan(
                                text: "ИНН: ",
                                style:
                                    TextStyle(color: NannyTheme.onSecondary)),
                            TextSpan(
                                text:
                                    vm.driver.userData.roleData?.inn ?? "Пусто",
                                style:
                                    const TextStyle(color: NannyTheme.primary))
                          ]))
                        ],
                      )
                    ],
                                  ...
                                  child: ListView(
                                    ...
                                    children: [
                                      ...
                                      carInfoPlate(
                                          title: "Марка",
                                          value:
                                              vm.driver.carDataText.autoMark),
                                      const SizedBox(height: 10),
                                      carInfoPlate(
                                          title: "Модель",
                                          value:
                                              vm.driver.carDataText.autoModel),
                                      const SizedBox(height: 10),
                                      carInfoPlate(
                                          title: "Цвет",
                                          value:
                                              vm.driver.carDataText.autoColor),
                                      const SizedBox(height: 10),
                                      carInfoPlate(
                                          title: "Год выпуска",
                                          value: vm
                                              .driver.carDataText.releaseYear
                                              .toString()),
                                      const SizedBox(height: 10),
                                      carInfoPlate(
                                          title: "Гос номер",
                                          value: vm
                                              .driver.carDataText.stateNumber),
                                      const SizedBox(height: 10),
                                      carInfoPlate(
                                          title: "СТС",
                                          value: vm.driver.carDataText.ctc),
                                    ],
                                  ),
                                ),
                                Material(
                                    ...
                                    children: vm.tariffs
                                        .map(
                                          (e) => e.id == -1
                                              ...
                                              : CheckboxListTile(
                                                  value: e.id <=
                                                      vm.maxAllowedTariffId,
                                                  activeColor:
                                                      NannyTheme.primary,
                                                  title: Text(e.title!),
                                                  onChanged: (_) =>
                                                      vm.changeMaxTariff(e.id)),
                                        )
                                        .toList(),
                                  ),
                                ),
