    ...
    return ElevatedButton(
      ...
      child: Padding(
        ...
        child: Row(
          ...
          children: [
            // Оборачиваем в Expanded, чтобы они занимали всю доступную высоту
            Expanded(
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  ...
                  Text(
                    ...
                    maxLines: 3, // Ограничение на количество строк
                    overflow: TextOverflow
                        .ellipsis, // Обрезка текста, если он не помещается
                  ),
                ],
              ),
            ),
            // Картинка или иконка, она будет стоять в том же ряду, но справа
