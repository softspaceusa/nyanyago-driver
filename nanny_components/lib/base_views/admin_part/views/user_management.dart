                              ...
                              : Slidable(
                                  endActionPane: ActionPane(
                                      ...
                                      children: [
                                        SlidableAction(
                                          flex: 2,
                                          onPressed: (context) => vm.banUser(
                                            e,
                                            previewDialogContexts: [context],
                                          ),
                                          backgroundColor: NannyTheme.darkGrey,
                                          icon: e.status == UserStatus.active
                                              ? Icons.no_accounts
                                              : Icons.account_circle,
                                          label: e.status == UserStatus.active
                                              ? "Заблокировать"
                                              : "Разблокировать",
                                        ),
                                        SlidableAction(
                                  ...
                                  child: ListTile(
                                    ...
                                    title: Text("${e.name} ${e.surname}",
                                        softWrap: true),
                                    subtitle: Text(vm.phoneMask
                                        .maskText(e.phone.substring(1))),
                                    trailing: Column(
                                    ...
                                    tileColor: e.status != UserStatus.active
