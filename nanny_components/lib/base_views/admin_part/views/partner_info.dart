...
class _PartnerInfoViewState extends State<PartnerInfoView> {
  ...
  void initState() {
    super.initState();
    vm = PartnerInfoVM(context: context, update: setState, partnerId: widget.partnerId);
  }
  
  @override
  Widget build(BuildContext context) { // TODO: Доделать
    return SafeArea(
      child: Scaffold(
        ...
        body: RequestLoader(
          ...
          completeView: (context, data) => AdaptBuilder(
            builder: (context, size) {
              if(data == null) return const ErrorView(errorText: "Партнер не состоит ни в одной франшизе");
              ...
              return Padding(
                ...
                child: Column(
                  children: [
                      ...
                      children: [
                        Expanded(
                          child: ElevatedButton(
                            ...
                            style: vm.showReferals ? null : NannyButtonStyles.whiteButton,
                        ...
                        Expanded(
                          child: ElevatedButton(
                            ...
                            style: vm.showReferals ? NannyButtonStyles.whiteButton : null,
                    ...
                    Expanded(
                      child: vm.showReferals ? ListView(
                        shrinkWrap: true,
                        children: data.roleData!.referals.map(
                          (e) => Column(
                            ...
                            children: [
                              ...
                              const Divider(color: NannyTheme.darkGrey)
                            ],
                          )
                        ).toList(),
                      )
